...
@section('page-title', 'Academic Data — Tambah Kehadiran')
...
<div class="max-w-2xl mx-auto">
    ...
    <nav class="flex items-center gap-2 text-xs text-slate-500 mb-6">
        ...
        <span class="text-slate-300 font-medium">Tambah Kehadiran</span>
    </nav>
    ...
    <div class="bg-slate-800 border border-slate-700 rounded-2xl p-6 lg:p-8">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-3 mb-1">
                ...
                <div>
                    <h2 class="text-lg font-bold text-slate-100">Tambah Data Kehadiran</h2>
                    <p class="text-xs text-slate-400">Masukkan data kehadiran mata kuliah</p>
                </div>
            </div>
        </div>
        ...
        {{-- Form --}}
        <form action="{{ route('kehadiran.store') }}" method="POST" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    <input type="number"
                           ...
                           value="{{ old('persentase_kehadiran') }}"
                           placeholder="0 — 100"
                           min="0"
                           max="100"
                           required
