...
@section('page-title', 'Academic Data — Edit Nilai')
...
<div class="max-w-2xl mx-auto">
    ...
    <nav class="flex items-center gap-2 text-xs text-slate-500 mb-6">
        ...
        <span class="text-slate-300 font-medium">Edit Nilai</span>
    </nav>
    ...
    <div class="bg-slate-800 border border-slate-700 rounded-2xl p-6 lg:p-8">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-3 mb-1">
                ...
                <div>
                    <h2 class="text-lg font-bold text-slate-100">Edit Nilai</h2>
                    <p class="text-xs text-slate-400">Perbarui data nilai <span class="text-slate-300 font-medium">{{ $nilai->mata_kuliah }}</span></p>
                </div>
            </div>
        </div>
